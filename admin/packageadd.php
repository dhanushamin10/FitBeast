...
<?php
 ...
 ?>
    <div class="container">
  <h1>Package Registration</h1><br>
  <div class="row">
   <div class="col-md-4 mx-auto">
    <div class="myform form ">
       <form action="" method="post" name="login">
        <div class="form-group">
         <input type="text" name="packagename"  class="form-control my-input" placeholder="Package Name">
        </div>
         <div class="form-group">
        ...
        if(isset($_POST["add"]))
      {
        ...
        try{
        $qry=mysqli_query($con,"INSERT INTO `package`(`name`,`price`)
