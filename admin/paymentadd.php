...
<?php
 ...
 ?>
    <div class="container">
  <h1>Add payment Info</h1><br>
  <div class="row">
   <div class="col-md-4 mx-auto">
    <div class="myform form ">
       <form action="" method="post" name="login">
        <div class="form-group">
         <input type="text" name="itemid"  class="form-control my-input" placeholder="Item ID">
        </div>
         <div class="form-group">
         <input type="text" name="memberid"  class="form-control my-input"  placeholder="Member ID">
        </div>
         <div class="form-group">
         <input type="text" name="mode"  class="form-control my-input"  placeholder="Payment Mode">
        </div>
        ...
        if(isset($_POST["add"]))
      {
        ...
        $qry=mysqli_query($con,"INSERT INTO `payments`(`memberid`,`itemid`,`mode`)
          values('$n1','$n','$n2')")or die(mysqli_error($con));
      }
